        ...
        <div class="col-12">
          <div class="card my-4">
            ...
            <div class="col-12 text-end pb-4">
                <a class="btn bg-gradient-primary mb-0" href="{{route('admin-tambah-berita-desa')}}"><i class="material-icons text-sm">add</i>&nbsp;&nbsp;Tambah Berita Desa</a>
            </div>
                ...
                <table class="table align-items-center mb-0">
                  ...
                  @foreach ($berita as $item => $data)
                    <tr>
                      ...
                      <td class="align-middle text-center">
                        <a href="/desa/berita/{{$data->id}}" class="badge badge-sm bg-gradient-success" data-toggle="tooltip" data-original-title="Edit user">
                          Ubah
                        </a>
                        <form onsubmit="return confirm('apakah kamu yakin ingin menghapus berita ini?')" action="{{route('admin-berita-desa-delete', $data->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('delete')
